...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour { 
        ...
        public GameObject panelOverlay { get => m_PanelOverlay; set => m_PanelOverlay = value; }
...
/*            action.GetBindingDisplayString(bindingIndex, out deviceLayoutName, out controlPath);
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (m_RebindOverlay == null && m_PanelOverlay == null && m_RebindText == null && m_RebindStartEvent == null && m_BindingText != null)
        ...
        bool CheckForDuplicateBind(InputAction action, int bindingIndex, bool allCompositeParts = false) {
            ...
            if (!allCompositeParts && bindingIndex > 0 && m_InputType == PLAYERINPUT.Keyboard) {
                for (int u = 0; u < 5; u++) {
                    if (u == bindingIndex) {
                        continue;
                    }
                    if (action.bindings[u].effectivePath == newBinding.effectivePath) {
                        return true;
                    }
                }
             }
             if (!allCompositeParts && bindingIndex > 1 && m_InputType == PLAYERINPUT.Controller) {
                for (int v = 5; v < 10 ; v++) {
                    ...
                    if (action.bindings[v].effectivePath == newBinding.effectivePath) {
                        return true;
                    }
                }
            }
        ...
        [Tooltip("Type of the binds the player uses")]
        [SerializeField]
        private  PLAYERINPUT m_InputType;
        ...
        [Tooltip("UI for blocking mouse raycast")]
        [SerializeField]
        private GameObject m_PanelOverlay;
