...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_PanelOverlayProperty = serializedObject.FindProperty("m_PanelOverlay");
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.PropertyField(m_InputTypeProperty);
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_PanelOverlayProperty);
        ...
        private SerializedProperty m_PanelOverlayProperty;
