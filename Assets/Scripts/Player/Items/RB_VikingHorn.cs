...
public class RB_VikingHorn : RB_Items
{
    ...
    public override void Attack()
    {
        ...
        {
            case 0: 
                RB_AudioManager.Instance.PlaySFX("Punch1", RB_PlayerController.Instance.transform.position, 0, 1);
                break;
            case 1: 
                RB_AudioManager.Instance.PlaySFX("Punch2", RB_PlayerController.Instance.transform.position, 0, 1);
                break;
            case 2: 
                RB_AudioManager.Instance.PlaySFX("Punch3", RB_PlayerController.Instance.transform.position, 0, 1);
                break;
        }
    ...
    public override void StartChargingAttack() {
        ...
        RB_AudioManager.Instance.PlaySFX("Charge_Charged_Attack_Viking_Horn", RB_PlayerController.Instance.transform.position, 0.15f, 1f);
    }

    public override void ChargedAttack() {
        base.ChargedAttack();
        RB_AudioManager.Instance.PlaySFX("Release_Charged_Attack_Viking_Horn", RB_PlayerController.Instance.transform.position, 0, 1);
    }
    ...
    public void JumpAttack()
    {
        if(_rb != null && _shouldJump)
        {
            ...
            if (_heightIndex > 1)
            {
                ...
                _isJumping = false;
                CurrentAttackCombo = 0;
                RB_AudioManager.Instance.PlaySFX("Jump_Attack_Viking_Horn", RB_PlayerController.Instance.transform.position, 0, 1f);
            }
        }
    }
