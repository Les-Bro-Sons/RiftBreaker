...
void CalculateHoles_float(float texWidth, float texHeight, float3 worldPosition, float3 cameraPosition, Texture2D entityPositionsTex, SamplerState samplerState, float posDivider, float holeRadius, out float3 hole)
{
